export function PlaceholderPortrait({ label, subtitle }: { label: string; subtitle: string }) {
  return (
    <div className="relative overflow-hidden rounded-[2rem] border border-coral/25 bg-gradient-to-br from-white via-black to-[#2a1f0c] p-6 shadow-soft">
      <div className="absolute -right-16 -top-16 h-48 w-48 rounded-full bg-coral/20 blur-3xl" />
      <div className="relative flex aspect-[4/5] flex-col items-center justify-center rounded-[1.5rem] border border-coral/20 bg-white/40 text-center">
