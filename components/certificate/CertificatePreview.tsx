...
export function CertificatePreview() {
  return (
    <article className="rounded-[2rem] border-4 border-double border-gold bg-cream p-8 text-center text-black shadow-gold">
      <div className="mx-auto flex justify-center"><LogoMark /></div>
      <p className="mt-6 text-sm uppercase tracking-[0.35em] text-[#7a551c]">Certificado de finalización</p>
      ...
      <p className="mt-3 font-display text-3xl font-bold text-[#7a551c]">{demoCertificate.studentName}</p>
