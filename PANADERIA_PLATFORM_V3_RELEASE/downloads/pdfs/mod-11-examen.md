# Examen — Variantes profesionales del bolillo

Puntaje mínimo: 80%

## Preguntas teóricas
1. Explica con tus palabras el propósito técnico de Variantes profesionales del bolillo.
2. Menciona tres señales observables que indiquen control en este módulo.
3. Describe una falla frecuente de Variantes profesionales del bolillo y su corrección profesional.
...
- Validación con Boly™ usando este prompt: "Boly™, revisa mi evidencia del módulo 11 y dime si demuestra criterio profesional o si falta una señal técnica".
