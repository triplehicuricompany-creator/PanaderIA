      ...
      <Section eyebrow="Curso Maestro de Bolillo" title="Versión Premium">
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-6 text-lg leading-8">
            <p>La versión premium reúne los 14 módulos reales del Curso Maestro de Bolillo con preparación para videos QR, fotografías técnicas, PDF descargable, material complementario y Boly™ por módulo.</p>
          ...
          <div className="rounded-3xl border border-gold/25 bg-charcoal p-8 shadow-gold">
            ...
            <ul className="mt-6 space-y-3 text-cream/80">
              <li>✦ 14 módulos reales de bolillo.</li>
              ...
              <li>✦ PDF descargable y material complementario.</li>
