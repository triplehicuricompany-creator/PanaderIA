# Evaluación final — Capítulo 3: Ingredientes del bolillo

## Instrucciones

Responde sin modificar el contenido técnico del curso. Usa la guía, los recursos visuales, el video, el QR y la intervención de Boly™ como apoyo.

## Preguntas

1. ¿Cuál es el objetivo principal de este capítulo?
2. ¿Qué recurso visual te ayudó más a comprenderlo y por qué?
3. ¿Qué decisión profesional debe tomar el alumno para comprender función técnica de harina, agua, sal y levadura?
4. ¿Cómo usarías a Boly™ para revisar una duda antes de avanzar?
5. ¿Qué recurso IA reemplazarías primero por material real del Chef Juanote™ y qué debe conservarse para no romper la estructura?

## Evidencia práctica

Entrega una nota breve donde demuestres que puedes evaluar ingredientes por calidad, medición y comportamiento esperado.

## Criterio de aprobación

- Comprende el objetivo del capítulo.
...
|---|---:|---:|---:|
| Explico el foco técnico: entender la función de harina, agua, sal y levadura en sabor, estructura y fermentación | [ ] | [ ] | [ ] |
| Presento evidencia verificable: evaluar ingredientes por calidad, medición, temperatura y comportamiento esperado | [ ] | [ ] | [ ] |
