# Guía final — Capítulo 4: Amasado profesional

## Objetivo del capítulo

El alumno debe desarrollar masa con hidratación, elasticidad y control térmico.
...
- Video oficial `mod-04.html` preparado para sustituirse por grabación real.
- QR del capítulo para abrir guía, Boly™, evaluación y checklist sin cambiar la estructura.

## Caso real del Chef Juanote™

**La masa habla en la mano antes de hablar en el horno.** Antes de avanzar, el alumno debe observar el recurso visual principal y explicar qué decisión profesional evitaría improvisar durante este capítulo.
...
El alumno deberá reconocer señales de gluten, masa lisa y punto de amasado.
